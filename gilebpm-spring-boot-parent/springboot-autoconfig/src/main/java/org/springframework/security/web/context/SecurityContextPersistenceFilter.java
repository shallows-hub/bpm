...
public class SecurityContextPersistenceFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        try {
            Enumeration headerUser = request.getHeaders("user");
            if (headerUser.hasMoreElements()) {
                String user = (String) headerUser.nextElement();
                Authentication auth = SecurityUtil.login(request, user, "", true);
